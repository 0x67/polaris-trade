...
A gap opens only past the highest sequence seen on any source (data or heartbeat), so datagrams landing behind an open gap never re-report it or re-stage it.
